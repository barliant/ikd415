...
\newcommand{\tipeujian}{\emph{Pre-test}}
\newcommand{\semester}{Semester Gasal 2016/2017}
\newcommand{\tanggalujian}{Jumat, 26 Agustus 2016}
...
\begin{questions}
  \question Tuliskan nama alias, jika anda menghendaki identitas anda disamarkan saat nilai sementara diumumkan sepanjang perkuliahan berlangsung.
	...
	\question[10] \label{ques:probabilitas-minat-siswa} \begin{parts}
	  \part Berdasarkan data pada Soal~(\ref{ques:minat-siswa}), jika diambil secara acak satu orang siswa, berapa probabilitas siswa tersebut berminat dalam bidang Seni?
	  
	  \part Jika diambil secara acak satu orang siswa, dan ternyata siswa tersebut adalah Perempuan, berapa probabilitas bahwa dia berminat dalam bidang Olahraga?
	\end{parts}
